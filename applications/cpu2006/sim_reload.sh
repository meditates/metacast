...
SE_OUT_DIR_CHECKPOINT=/users/meditate/cpu2006/benchspec/CPU2006/${NUMBER}.${NAME}/run/run_base_ref_arm.0000/m5out/${NAME}

cd /users/meditate/cpu2006/benchspec/CPU2006/${NUMBER}.${NAME}/run/run_base_ref_arm.0000/

/users/meditate/gem5/build/ARM/gem5.fast --outdir=${SE_OUT_DIR_RELOAD}/${22} \
/users/meditate/gem5/configs/example/spec06_config.py \
--benchmark=${NAME} \
--cpu-type=DerivO3CPU \
--caches \
--l2cache \
